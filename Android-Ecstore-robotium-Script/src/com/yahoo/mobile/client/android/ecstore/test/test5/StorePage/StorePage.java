 ...
 * client.android.ecstore.test.test5.StorePage.StorePage -w com.yahoo.mobile.
 ...
 *
 */
package com.yahoo.mobile.client.android.ecstore.test.test5.StorePage;
...
public class StorePage extends ActivityInstrumentationTestCase2<Activity> {
	...
	public final void testStorePromotionItemDisplay() throws Exception {
		...
		if (android.os.Build.VERSION.RELEASE.matches("4.0." + "[0-9]+")) {
			...
			// click store LOGO.
			Action.clickElementsInWebviewByClassnameByLowVersion(solo, "pimg");
			solo.sleep(ValidationText.WAIT_TIME_ONESEC);
			TestHelper.swipeUp(solo, 1);
