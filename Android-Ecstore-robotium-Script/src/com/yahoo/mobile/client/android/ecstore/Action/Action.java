...
public final class Action {
	...
	public static final int VIEW_ID_ZERO = 0, VIEW_ID_ONE = 1, VIEW_ID_TWO = 2,
			...
			VIEW_ID_EIGHT = 8, VIEW_ID_TEN = 10, VIEW_ID_TWENTY = 20,
	...
	public static void removeFavoriteStore(final Solo solo) throws Exception {
		...
		View storeName;
		try {
			storeName = (View) solo.getView("listitem_favoritestore_storename");
	...
	public static void addToShoppingCart(final Solo solo) throws Exception {
		...
		try {
			...
			/*
			 * TestHelper.swipeUp2(solo, 2); //
			 * solo.sleep(ValidationText.WAIT_TIME_SHORT); View shopCarts = solo
	...
	public static void buyNow(final Solo solo) throws Exception {
		...
		try {
			...
			TestHelper.swipeUp2(solo, 2);
			// solo.sleep(ValidationText.WAIT_TIME_SHORT);
			View shopCarts = solo.getView("productitem_btn_purchase_now");
			solo.clickOnView(shopCarts);
		}
		View buddle;
	 ...
	 *             if has error
	 */
	public static void clickElementsInWebviewByClassnameByLowVersion(
			final Solo solo, final String text) throws Exception {
	 ...
	 *             if has error
	 */
	public static void searchClassNameOnWebview(final Solo solo,
			final String text) throws Exception {
	 ...
	 *             if has error
	 */
	public static void enterToPromotion(final Solo solo) throws Exception {
	 ...
	 *             if has error
	 */
	public static void deleteProductCollected(final Solo solo) throws Exception {
	 ...
	 *             if has error
	 */
	public static void select711AndCheckout(final Solo solo) throws Exception {
