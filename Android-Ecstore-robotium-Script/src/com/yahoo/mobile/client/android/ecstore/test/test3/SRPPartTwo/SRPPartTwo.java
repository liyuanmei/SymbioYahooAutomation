 ...
 * .android.ecstore.test.test3.SRPPartTwo.SRPPartTwo -w com.yahoo.mobile.client.android.
...
package com.yahoo.mobile.client.android.ecstore.test.test3.SRPPartTwo;
...
public class SRPPartTwo extends ActivityInstrumentationTestCase2<Activity> {
	...
	public final void testStoreCountDisplay() throws Exception {
		...
		TextView count = (TextView) solo
				.getView("listitem_storelist_store_item_count");
	...
	public final void testHeartIconDisplay() throws Exception {
		...
		// compare the position of two views
		boolean flag = TestHelper.positionCompare(solo,
				"listitem_storelist_store_rating", 0, "heart_button", 0,
	...
	public final void testCheckTheDefaultBrowseMode() throws Exception {
		...
		assertEquals("view count not 20.", Action.DEFAULT_LISTVIEW_COUNT,
				defaultItems);
	...
	public final void testFilterByPrice() throws Exception {
		...
		Log.i("number", sr);
		assertTrue("The product price out of range. ",
