 ...
 * android.ecstore.test.test1.CategoryPartTwo.CategoryPartTwo -w com.yahoo.mobile.client.android.
...
package com.yahoo.mobile.client.android.ecstore.test.test1.CategoryPartTwo;
...
public class CategoryPartTwo extends ActivityInstrumentationTestCase2<Activity> {
	...
	public final void testCommodityPriceDisplayInGridView() throws Exception {
		...
		assertTrue(" Cannot find the commodity price or price format"
				+ " is incorrect! ", isNumMoney);
	...
	public final void testCommodityPriceDisplayInLargePhotoView()
		...
		assertTrue(" Cannot find the commodity price or price "
				+ "format is incorrect! ", isNumPrice);
	 ...
	 *             if has error
	 */
	public final void testStarIconDisplayInLargePhotoView() throws Exception {
	...
	public final void testStarIconWithoutLoginInLargePhotoView()
		...
		View star = (View) solo.getView("star_button", 0);
		solo.clickOnView(star);
		assertTrue("toastText",
				solo.waitForText(ValidationText.PLEASE_LOGIN_ACCOUNT));
	 ...
	 *             if has error
	 */
	public final void testStartIconInLargePhotoViewWhenLogin() throws Exception {
		...
		try {
			...
			if (solo.waitForText(ValidationText.HAS_ADDED_COLLECTION)) {
				alreadyAdd = solo
						.waitForText(ValidationText.HAS_ADDED_COLLECTION);
	...
	/**
	 * 1938159:Verify Sports/Outdoor/Leisure tab correctly displayed on the
	 * page.
	 * 
	 * @throws Exception
	 *             if has error
	...
	public final void testVerifyTheSortFunction() throws Exception {
		...
		//Assert the first price is lower than second.
	 ...
	 *             if has error
	 */
	public final void testEditFavoriteCategoryInMyAccount() throws Exception {
	 ...
	 *             if has error
	 */
	public final void testVerifyCancelFunction() throws Exception {
		...
		// solo.clickOnToggleButton("Credit cards");
		ToggleButton tb = (ToggleButton) solo.getView("tb_cc");
		solo.clickOnView(tb);
