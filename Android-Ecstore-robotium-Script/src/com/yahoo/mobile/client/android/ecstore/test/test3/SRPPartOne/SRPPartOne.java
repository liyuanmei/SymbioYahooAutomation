 ...
 * .android.ecstore.test.test3.SRPPartOne.SRPPartOne -w com.yahoo.mobile.client.android.
...
package com.yahoo.mobile.client.android.ecstore.test.test3.SRPPartOne;
...
public class SRPPartOne extends ActivityInstrumentationTestCase2<Activity> {
	...
	public final void testCheckConfirmButtonFunction() throws Exception {
		...
		assertEquals("Go back to search result screen failed", gvList.size(), 1);
	...
	public final void testHasVideoDisplay() throws Exception {
		...
		assertTrue("Has video button is not selected.", tb.isChecked());
	 ...
	 *             if has error
	 */
	public final void testNavigateToItemPageByClickGoodsName() throws Exception {
	...
	public final void testStarIconWithoutLogin() throws Exception {
		...
		if (!solo.waitForText(ValidationText.PLEASE_LOGIN_ACCOUNT, 1,
	...
	public final void testCommodityPriceDisplayInLargeStyle() throws Exception {
		...
		assertTrue(" Cannot find the commodity price or "
				+ "price format is incorrect! ", isNum);
	 ...
	 *             if has error
	 */
	public final void testGoodsEvaluationDisplayInLargeStyle() throws Exception {
